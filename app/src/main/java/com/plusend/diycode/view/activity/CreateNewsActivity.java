...
import com.plusend.diycode.model.news.node.presenter.NewsNodesBasePresenter;
import com.plusend.diycode.model.news.node.view.NewsNodesView;
import com.plusend.diycode.model.news.presenter.CreateNewsBasePresenter;
                ...
                .setAction("登录", new View.OnClickListener() {
                    @Override public void onClick(View v) {
                        startActivityForResult(
                            new Intent(CreateNewsActivity.this, SignInActivity.class),
