...
public class TopicFragment extends Fragment implements TopicsView {
            ...
            @Override public void onScrollStateChanged(RecyclerView recyclerView, int newState) {
                ...
                if (newState == RecyclerView.SCROLL_STATE_IDLE
                    ...
                    if (type == TYPE_ALL) {
                        ...
                        ((UserTopicsPresenter) topicsBasePresenter).getUserCreateTopics(loginName,
                            offset);
                    } else if (type == TYPE_FAVORITE) {
                        ((UserTopicsPresenter) topicsBasePresenter).getUserFavoriteTopics(loginName,
                            offset);
                    }
                }
            }
    ...
    @Override public void showTopTopics(List<Topic> topicList) {
        if (topicList == null) {
